...
<head>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 0;
            background-image: url('s.jpg'); /* Add your background image path */
                ...
                if(isset($_POST['submit'])){
                    ...
                    if(is_array($row) && !empty($row)){
                        if(password_verify($password, $row['Password'])) {
                            ...
                            $_SESSION['id'] = $row['Id'];
                            header("Location: jklastop12sfkfio3.php"); // Redirect to supp_home.php
                            exit(); // Add this to stop further execution
                        } else {
                            echo "<div class='message'>
                                <p>Wrong Password</p>
                                </div> <br>";
                            echo "<a href='supp.php'><button class='btn'>Go Back</button>";
                        }
                    }else{
                        echo "<div class='message'>
                        <p>User not found</p>
