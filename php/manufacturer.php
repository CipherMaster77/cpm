...
<head>
    ...
    margin: 0;
    padding: 0;
    background-image: url('https://www.thebusinessconcept.com/wp-content/uploads/2022/12/Supply-Chain-Logistics.jpg'); /* Add your background image path */
...
if(isset($_POST['submit'])){
    ...
    if (is_array($row) && !empty($row)) {
        if (password_verify($password, $row['Password'])) {
            ...
            $_SESSION['id'] = $row['Id'];
            header("Location: jklastop12sfkfio2.php"); // Redirect to verification.php
            exit(); // Add this to stop further execution
        } else {
            echo "<div class='message'>
                <p>Wrong Password</p>
                </div> <br>";
            echo "<a href='manufacturer.php'><button class='btn'>Go Back</button>";
        }
    } else {
        echo "<div class='message'>
        <p>User not found</p>
