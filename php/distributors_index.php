...
<head>
    ...
    margin: 0;
    padding: 0;
    background-image: url('D.webp'); /* Add your background image path */
                ...
                if(isset($_POST['submit'])){
                    ...
                    if(is_array($row) && !empty($row)){
                        if(password_verify($password, $row['Password'])) {
                            ...
                            $_SESSION['id'] = $row['Id'];
                            header("Location: distributors_home.php");
                            exit(); // Add this to stop further execution
                        } else {
                            echo "<div class='message'>
                                <p>Wrong Password</p>
                                </div> <br>";
                            echo "<a href='distributors_index.php'><button class='btn'>Go Back</button>";
                        }
                    }else{
                        echo "<div class='message'>
                        <p>User not found</p>
